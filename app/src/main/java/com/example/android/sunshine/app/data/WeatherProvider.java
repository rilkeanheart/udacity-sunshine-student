...
public class WeatherProvider extends ContentProvider {
    ...
    static UriMatcher buildUriMatcher() {
        ...
        UriMatcher thisUriMatcher = new UriMatcher(UriMatcher.NO_MATCH);
        String authority = WeatherContract.CONTENT_AUTHORITY;


        // 2) Use the addURI function to match each of the types.  Use the constants from
        // WeatherContract to help define the types to the UriMatcher.
        thisUriMatcher.addURI(authority,"weather",WEATHER);
        thisUriMatcher.addURI(authority,"weather/*",WEATHER_WITH_LOCATION);
        thisUriMatcher.addURI(authority,"weather/*/#",WEATHER_WITH_LOCATION_AND_DATE);
        thisUriMatcher.addURI(authority,"location",LOCATION);

        // 3) Return the new matcher!
        return thisUriMatcher;
    }
