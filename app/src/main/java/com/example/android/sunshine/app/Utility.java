...
public class Utility {
    ...
    public static String getPreferredLocation(Context context) {
        ...
        String strPreferredLocation = prefs.getString(context.getString(R.string.pref_location_key),
                context.getString(R.string.pref_location_default));
        return strPreferredLocation;
    }
    ...
    public static String formatWindSpeed(Context context, float windSpeed, float degrees) {
        int windFormat;
    ...
    static public void resetLocationStatus(Context c){
        ...
        //spe.putString(c.getString(R.string.pref_location_key), "94303");
        spe.apply();
    }
}